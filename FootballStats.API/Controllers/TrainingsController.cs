...
public class TrainingsController : ControllerBase
{
    ...
    public TrainingsController(IMediator mediator, IUriService uriService, LinkGenerator linkGenerator)
    {
        _mediator = mediator;
    ...
    public async Task<ActionResult> GetAllTrainingsAsync([FromQuery] TrainingsQueryStringParams filter)
    {
        ...
        TrainingResponseWrapper.GenerateLinksForTrainings(trainingsResponse, _linkGenerator, HttpContext);
    ...
    public async Task<ActionResult> GetTrainingByIdAsync(int trainingId)
    {
        ...
        TrainingResponseWrapper.GenerateLinksForTraining(trainingResponse, _linkGenerator, HttpContext);
