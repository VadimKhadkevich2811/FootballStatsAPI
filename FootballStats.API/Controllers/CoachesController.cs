...
public class CoachesController : ControllerBase
{
    ...
    public CoachesController(IMediator mediator, IUriService uriService, LinkGenerator linkGenerator)
    {
        _mediator = mediator;
    ...
    public async Task<ActionResult> GetAllCoachesAsync([FromQuery] CoachesQueryStringParams filter)
    {
        ...
        CoachResponseWrapper.GenerateLinksForCoaches(coachesResponse, _linkGenerator, HttpContext);
    ...
    public async Task<ActionResult> GetCoachByIdAsync(int coachId)
    {
        ...
        CoachResponseWrapper.GenerateLinksForCoach(coachResponse, _linkGenerator, HttpContext);
    ...
    public async Task<ActionResult> GetFreeCoachesByDateAsync([FromQuery] DateTime date)
    {
        ...
        CoachResponseWrapper.GenerateLinksForCoaches(freeCoachesResponse, _linkGenerator, HttpContext);
