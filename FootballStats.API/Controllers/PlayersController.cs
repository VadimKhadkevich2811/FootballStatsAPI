...
public class PlayersController : ControllerBase
{
    ...
    private readonly IResponseWrapper<PlayerReadDto, PlayersListWithCountDto> _responseWrapper;

    public PlayersController(IMediator mediator, IUriService uriService,
        IResponseWrapper<PlayerReadDto, PlayersListWithCountDto> responseWrapper)
    {
        _mediator = mediator;
    ...
    public async Task<ActionResult> GetAllPlayersAsync([FromQuery] PlayersQueryStringParams filter)
    {
        ...
        _responseWrapper.GenerateLinksForMany(playersResponse);
    ...
    public async Task<ActionResult> GetPlayerByIdAsync(int playerId)
    {
        ...
        _responseWrapper.GenerateLinksForOne(playerResponse);
    ...
    public async Task<ActionResult> CreatePlayerAsync(CreatePlayerCommand command)
    {
        ...
        return CreatedAtRoute("GetPlayerByIdAsync", new { PlayerId = playerResponse.Data!.Id }, playerResponse);
    }
    ...
    public async Task<ActionResult> GetFreePlayersByDateAsync([FromQuery] DateTime date)
    {
        ...
        _responseWrapper.GenerateLinksForMany(freePlayersResponse);
