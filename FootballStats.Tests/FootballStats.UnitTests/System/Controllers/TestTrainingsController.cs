...
public class TestTrainingsController
{
    ...
    public async Task GetAllTrainingsAsync_ShouldReturn200Status()
    {
        ...
        var sut = new TrainingsController(_mediatorMoq.Object, _uriServiceMoq.Object, _linkGeneratorMoq.Object)
        {
